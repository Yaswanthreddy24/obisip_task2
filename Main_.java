...
class Main_ extends JFrame
{
    ...
    public Main_()
    {
        ...
        JLabel j=new JLabel("Guess the number game");
    ...
    private class ButtonListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if(a<rand)
            {
                j4.setText(a+" is low, try again!!");
            }    
            else if(a>rand)
            {
                j4.setText(a+" is high, try again!!");
            }
            else
            {
                j4.setText("CORRECT GUESS, YOU WIN!!!!");    
                if(count<bestScore)
                {    
                    bestScore=count;
